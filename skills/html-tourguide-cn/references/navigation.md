...
Use this file when you need exact URL and fallback behavior for the HTML guide.
...
For non-walking modes, map them to the closest Google Maps travel mode:
...
For route planning with coordinates, build the Amap navigation URL if appropriate.
